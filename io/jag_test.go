...
func TestGnomeballButtonsHash(t *testing.T) {
	...
	if result != 22834782 {
		t.Errorf("TestGnomeballButtonsHash expected 22834782, got %d", result)
	}
}
...
func TestHeadiconsHash(t *testing.T) {
	...
	if result != -288954319 {
		t.Errorf("TestHeadiconsHash expected -288954319, got %d", result)
	}
}
...
func TestHitmarksHash(t *testing.T) {
	...
	if result != -1502153170 {
		t.Errorf("TestHitmarksHash expected -1502153170, got %d", result)
	}
}
